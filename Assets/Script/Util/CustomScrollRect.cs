...
public class CustomScrollRect : Page,IBeginDragHandler, IEndDragHandler, IDragHandler {
	...
	public delegate void UpdatePageNumber(int pageNumer);
	public event UpdatePageNumber updatePageNumber;
	...
	void Update()
	{
		if (_lerp)
		{
			...
			if(updatePageNumber!=null){
				updatePageNumber(CurrentScreen());
			}
		}
